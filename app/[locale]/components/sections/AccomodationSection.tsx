    ...
    return (
        <section id="accomodations">
            <div className="h-200">
                ...
                <div className={`h-4/5 md:h-2/3 ${colorSchema.primaryBg} flex flex-col md:flex-row item-center justify-center`}>
                    <div className="flex flex-col md:flex-row gap-0 md:gap-10 md:px-10 items-center justify-center">
                        <p className={`${colorSchema.secondaryText} flex items-center whitespace-pre-line text-sm md:text-xl tracking-wide flex-1 lg:max-w-[1000] px-6 pb-12 sm:pb-28 md:pb-0`}>{dictionary.accomodationsSection.desc1}</p>
            ...
            <div className="md:h-200">
                <div className={`h-[160] md:h-1/3 ${colorSchema.tertiaryBg} flex items-center px-4 md:px-10`}>
                ...
                <div className={`md:h-2/3 ${colorSchema.primaryBg} flex item-center justify-center py-20 md:py-0`}>
                    <div className="flex flex-col md:flex-row items-center w-full justify-evenly gap-14 xl:gap-30 px-4">
